...
ActiveRecord::Schema[7.0].define(version: 2022_07_01_113222) do
  ...
  create_table "job_applications", force: :cascade do |t|
    ...
    t.index ["user_datum_id"], name: "index_job_applications_on_user_datum_id"
  end
  ...
  add_foreign_key "job_applications", "user_data"
